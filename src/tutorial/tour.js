...
const tour = [{
  ...
  content: 
    <span>
      Thanks for taking the time. Have fun exploring.
      If you want to know more about Peripleo, <a href="https://github.com/britishlibrary/peripleo-lanc" target="_blank">click here</a>.
    </span>
}];
